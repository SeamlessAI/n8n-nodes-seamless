...
const taskFields: INodeProperties[] = [
	...
	// ------ Execute Action ------
	{
		...
		options: [
			...
			{ name: 'Pause', value: 'pause', action: 'Pause a task' },
			{
				name: 'Reschedule',
				value: 'reschedule',
				action: 'Reschedule a task',
			},
			{ name: 'Schedule', value: 'schedule', action: 'Schedule a task' },
			{ name: 'Skip', value: 'skip', action: 'Skip a task' },
			{ name: 'Start', value: 'start', action: 'Start a task' },
			{ name: 'Unpause', value: 'unpause', action: 'Unpause a task' },
		],
	},
	// ------ Get Many ------
	{
